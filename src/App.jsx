...
const iStyle = { width:"100%", padding:"9px 12px", border:"1px solid #e2e8f0", borderRadius:8, fontSize:14, boxSizing:"border-box", background:"#f8fafc" };
...
export default function App() {
  ...
  return (
    <div style={{ fontFamily:"sans-serif", background:"#f1f5f9", minHeight:"100vh", color:"#1e293b" }}>
      ...
      {/* ヘッダー */}
      <div style={{ background:"linear-gradient(135deg,#6366f1,#818cf8)", color:"#fff", padding:"16px 20px", position:"relative" }}>
        <div style={{ position:"absolute", top:16, right:20 }}>
          <LoginButton />
        </div>
        <div style={{ fontSize:18, fontWeight:700 }}>💰 貯金管理ダッシュボード</div>
        <div style={{ fontSize:30, fontWeight:800, marginTop:4 }}>{fmt(totalBalance)}</div>
        <div style={{ fontSize:12, opacity:.8 }}>総合計残高</div>
      </div>
